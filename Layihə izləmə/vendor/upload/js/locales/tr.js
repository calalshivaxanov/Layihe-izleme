...
(function ($) {
    ...
    $.fn.fileinputLocales['tr'] = {
        ...
        msgFilePreviewError: '"{name}" dosyası okunurken bir xeta oluştu.',
        ...
        msgUploadError: 'xeta',
        msgValidationError: 'Doğrulama xetası',
        ...
        msgImageResizeException: 'Görüntü boyutlandırma sırasında xeta.<pre>{errors}</pre>',
        ...
        fileActionSettings: {
            ...
            indicatorErrorTitle: 'Yükleme xetası',
